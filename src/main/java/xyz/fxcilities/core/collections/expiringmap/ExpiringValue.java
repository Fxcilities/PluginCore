...
/**
 * A value which should be stored in an {@link ExpiringMap} with optional control over its
 * expiration.
 *
...
public final class ExpiringValue<V> {
   ...
   * {@link ExpirationPolicy expiration policy} and {@link ExpiringMap#getExpiration()} expiration}
   * will be used.
   *
  ...
  /**
   * Creates an ExpiringValue to be stored in an {@link ExpiringMap}. The map's default {@link
   * ExpiringMap#getExpiration()} expiration} will be used.
   *
   * @param value the value to store
  ...
  /**
   * Creates an ExpiringValue to be stored in an {@link ExpiringMap}. The map's default {@link
   * ExpirationPolicy expiration policy} will be used.
   *
   * @param value the value to store
  ...
  public ExpiringValue(
      V value, ExpirationPolicy expirationPolicy, long duration, TimeUnit timeUnit) {
  ...
  private ExpiringValue(
      V value, long duration, TimeUnit timeUnit, ExpirationPolicy expirationPolicy) {
    this.value = value;
