...
public class Chat {
    ...
    /**
     * Send a messagge to a {@link CommandSender}. Will automatically format using {@link #format(String)}
     * @param showPrefix If the prefix should be sent in the message
     * @param sender Sender to send the message to. {@link Player} can be passed in, and everything else that {@link CommandSender} (in this case {@link org.bukkit.permissions.ServerOperator})
